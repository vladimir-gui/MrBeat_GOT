...
class MainWidget(RelativeLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.audio_mixer = self.audio_engine.create_mixer(
            self.sound_kit_service.soundkit.get_all_samples(), self.bpm, TRACK_NB_STEPS, self.on_current_step_changed, MIN_BPM
        )
    ...
    def on_current_step_changed(self, step_index):
        # print(step_index)
